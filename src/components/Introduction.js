        ...
        <div className="min-h-screen w-full flex items-center justify-center text-white">
            <div className="max-w-6xl">
                <div className="p-20 flex flex-col space-y-4">
                    <h1 className="font-bold text-8xl">Hi, I'm JR Mohan!</h1>
                    <h1 className="font-semibold text-4xl ">A Full-Stack Developer</h1>
                    ...
                    <button className="w-36 h-12 text-xl rounded-md bg-orange-400 text-black">Contact Me</button>
                </div>
            </div>
        </div>
    )
