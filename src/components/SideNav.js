...
export default function SideNav({ref1, ref2, ref3, ref4, ref5}){
    ...
    return(
    <SideReveal>
        <div className="h-screen bg-zinc-950 text-white hidden sm:block top-0 w-14 z-50 flex-col">
            <div className="h-16 w-14 flex justify-center items-center text-2xl font-bold">
                <button 
                    ...
                    className="w-12 h-12 rounded-md flex justify-center items-center bg-neutral-900 hover:cursor-pointer hover:bg-neutral-800"
                >
